...
def printMenu():
    print("SELECCION UNA OPCION\n" +
          ...
          "5. NUMERO DE LINEAS DEL ARCHIVO.\n" +
          "6. COPIE LA ULTIMA MITAD DE LOS REGISTROS/LINEAS DEL ARCHIVO A OTROO ARCHIVO LLAMADO nuevo-archivo_1.txt.\n" +
          "7. GENERAR 26 ARCHIVOS DEL LA A A LA Z.\n" +
